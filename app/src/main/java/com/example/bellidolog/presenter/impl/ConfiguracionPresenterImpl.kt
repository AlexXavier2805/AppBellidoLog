...
import com.example.bellidolog.view.fragment.ConfiguracionFragment

class ConfiguracionPresenterImpl(private val view: ConfiguracionFragment) : ConfiguracionPresenter{
